...
public class Exercise_22
{
    public static void main(String[] args)
    {
        ...
        int[] dimensions1 = Arrays.stream(input.nextLine().split("\\s")).mapToInt(Integer::parseInt).toArray();
        int[] dimensions2 = Arrays.stream(input.nextLine().split("\\s")).mapToInt(Integer::parseInt).toArray();
