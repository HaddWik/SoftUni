...
public class Exercise_25
{
    public static void main(String[] args)
    {
        ...
        ArrayList<Book> books = getBooks(input);
        Date releaseDate = getReleaseDate(input);
    ...
    private static void printTitlesByReleaseDate(Map<Date, ArrayList<String>> titlesByDate)
    {
        ...
        {
            ArrayList<String> titlesOrdered = titlesByDate.get(date).stream().sorted( (t1, t2) -> t1.compareTo(t2)).collect(Collectors.toCollection(ArrayList<String>::new));
